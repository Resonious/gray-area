...
(function(){
  var ref$, each, all, fold, foldr, filter, reject, map, empty, keys, values, abs, signum, join, x$, bodyBounds, unionify, unionExcluding, area, dimensionFrom, dimensionBetween;
