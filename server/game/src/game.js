...
(function(){
  var ref$, each, all, map, filter, first, head, lines, keys, values, GameCore, customAddFunctions;
  ref$ = require('prelude-ls'), each = ref$.each, all = ref$.all, map = ref$.map, filter = ref$.filter, first = ref$.first, head = ref$.head, lines = ref$.lines, keys = ref$.keys, values = ref$.values;
  this.GameCore = GameCore = (function(){
    ...
    prototype.render = function(){
      'ass';
      this.game.debug.body(this.currentLevel.gray);
    };
    ...
    prototype.switchPlayers = function(){
      ...
      if (this.currentPlayer(otherColor).finished) {
        this.cantSwapSound.play('', 0, 1, false);
        return;
      }
